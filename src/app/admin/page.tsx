...
import { Home, ListChecks, Loader2, AlertTriangle } from 'lucide-react';
      ...
      <main className="container mx-auto py-8 px-4">
        <Card className="shadow-xl rounded-xl">
          <CardHeader>
            ...
            <CardDescription>Manage your Bookly application settings and view all bookings.</CardDescription>
          </CardHeader>
              ...
              <div className="mt-6">
                {isLoadingBookings && !allBookings.length ? (
                  ...
                  <ScrollArea className="h-[500px] w-full rounded-md border p-4 bg-card">
                    <h3 className="text-xl font-semibold mb-4 font-headline text-primary">All Bookings</h3>
                    <Table>
                      <TableHeader>
                        <TableRow>
